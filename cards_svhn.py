...
def center_crop(origin_img):
    ...
    img = misc.imresize(center_cropped_img, (32, 32), interp='nearest').astype('float32')
    return img


def build_cnn(input_var=None):
    snapshot_root = 'snapshot_models/svhn/'
    trained_params = read_params(snapshot_root + '170316163956/999_params')
