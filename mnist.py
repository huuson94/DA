...
def main(model='mlp', num_epochs=500):
    ...
    snapshot_name = 'mnist/'+ time_stamp + '/'
    ...
    # Finally, launch the trainingfilename loop.
    ...
    copy2('mnist.py', snapshot_root + snapshot_name)
    ...
    for epoch in range(num_epochs):
        ...
        print("Modify of {} took {:.3f}s".format(
            num_epochs, time.time() - start_time))
    	...
    	#if True:
        if(epoch +1) % 50 == 0:
            snapshot_path_string = snapshot_root+snapshot_name+str(epoch)
            ...
            save_history(training_history, snapshot_path_string+"_"+"history")
        #exit(0)
